// ==========================================================
// Secure Password Manager - Version 25
// ----------------------------------------------------------
// This version improves password encryption.
//
// Features:
// - Generate passwords
// - Display passwords
...
// - Detect encrypted data tampering
...
function decryptPassword(encryptedPassword) {
    ...
    try {
        ...
        // Convert stored authentication tag to Buffer
...
if (fs.existsSync("passwords.json")) {
    ...
    if (data.trim() !== "") {
        ...
        try {
            ...
            if (!Array.isArray(encryptedPasswords)) {
            ...
            console.log(
                "Unable to load encrypted password data."
            );
